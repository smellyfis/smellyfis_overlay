...
SRC_URI="https://github.com/prusa3d/slic3r/archive/version_1.42.0-alpha3.tar.gz -> ${P}.tar.gz"
MASTERS=gentoo
...
S="${WORKDIR}/Slic3r-version_1.42.0-alpha3/"

src_prepare() {
	#pushd "${WORKDIR}/Slic3r-version_${PV}" || die
	pushd "${WORKDIR}/Slic3r-version_1.42.0-alpha3" || die
