...
SRC_URI="https://github.com/prusa3d/PrusaSlicer/archive/version_2.0.0.tar.gz -> ${P}.tar.gz"
MASTERS=gentoo
...
S="${WORKDIR}/PrusaSlicer-version_2.0.0/"

src_prepare() {
	#pushd "${WORKDIR}/Slic3r-version_${PV}" || die
	pushd "${WORKDIR}/PrusaSlicer-version_2.0.0" || die
